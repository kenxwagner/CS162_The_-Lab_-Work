...
{		friend istream &operator >> (istream &,Fractionclass & );  // function prototype
		friend ostream &operator << (ostream &,Fractionclass & );  // function prototype
    public:
...
{cout << "In the operator >> function " << endl;
 ...
 ostream &operator << (ostream &output ,Fractionclass &object)
{cout << "In the operator << function " << endl;
  output << object.numerator;
  output << object.demominator;
  return output;
}
...
{ 
  ...
  cin >> fraction2;
  cout << fraction1 <<endl;   //To be able to do this, you need to overload the     
                         //insertion << operator.
  ...
  cout << fraction3 <<endl;   // If fraction1 contains 2/3 and fraction2 contains 1/5 then 
